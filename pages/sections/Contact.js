        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-8 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 mr-2 sm:rounded-lg" style={bg}>
                        <h1 class="text-4xl sm:text-5xl text-yellow-200 dark:text-white font-extrabold tracking-tight">
                            Get in touch
                        </h1>
                        ...
                        <div class="flex items-center mt-8 text-white dark:text-gray-400">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" class="w-8 h-8 white">
...
Tc14/733, Nandavanam, Thiruvananthapuram
                    ...
                    <form class="p-6 flex flex-col justify-center">
                        ...
                        <button type="submit" class="md:w-32 bg-purple-400 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300" style={bg}>
                            Submit
                        </button>
                    </form>
                </div>
